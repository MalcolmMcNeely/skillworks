...
public sealed class HealthEndpointTests
{
    ...
    {
        using var studio = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue());
    ...
    {
        using var studio = new Studio(Studio.Fixture("malformed"), Studio.Catalogue());
    ...
    {
        using var studio = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue(), settings: "{ not json");
    ...
    public async Task Reports_an_events_store_that_is_down_as_broken_and_says_how_to_start_it()
    {
        ...
        using var studio = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue(), events: events);
    ...
    {
        using var studio = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue(), emitting: false);
    ...
    public async Task Tells_a_store_that_is_down_apart_from_telemetry_that_is_switched_off()
    {
        ...
        using var broken = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue(), events: down);
        using var off = new Studio(Studio.Fixture("ordinary"), Studio.Catalogue(), events: quiet, emitting: false);
    ...
    {
        using var studio = new Studio("no-such-folder", Studio.Catalogue());
    ...
    public async Task Blames_an_empty_folder_on_the_folder_rather_than_on_the_history()
    {
        ...
        using var studio = new Studio(folder.Subfolder("no-sessions"), Studio.Catalogue());
