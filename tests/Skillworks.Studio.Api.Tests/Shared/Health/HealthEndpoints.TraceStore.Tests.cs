...
public sealed partial class HealthEndpointsTests
{
    ...
    public async Task Reports_a_trace_store_that_is_down_as_broken_and_says_how_to_start_it()
    {
        ...
        using var studio = new StudioHost(StudioHost.Marketplace(), traces: traces);
    ...
    {
        using var studio = new StudioHost(StudioHost.Marketplace(), tracing: false);
    ...
    {
        using var studio = new StudioHost(StudioHost.Marketplace(), emitting: false, tracing: false);
    ...
    public async Task Tells_a_trace_store_that_is_down_apart_from_traces_that_are_switched_off()
    {
        ...
        using var broken = new StudioHost(StudioHost.Marketplace(), traces: down);
        using var off = new StudioHost(StudioHost.Marketplace(), tracing: false);
