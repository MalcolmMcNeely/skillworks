...
{
    [Fact]
    public void A_csharp_test_at_the_path_that_mirrors_its_code_is_not_a_breach()
    {
    ...
    [Fact]
    public void A_csharp_test_whose_code_sits_in_another_folder_is_told_where_to_move()
    {
        using var tree = new RulesTree()
            .Write("src/App/App.csproj", ProjectFile)
    ...
    [InlineData(null)]
    public void A_csharp_test_outside_a_Tests_project_has_no_code_to_mirror(string? projectFile)
    {
    ...
    public void A_front_end_test_beside_a_module_of_its_subject_is_not_a_breach(string module)
    {
        using var tree = new RulesTree()
            .Write(module)
    ...
    public void A_front_end_test_with_no_module_of_its_subject_beside_it_is_a_breach(string module)
    {
        using var tree = new RulesTree()
            .Write(module)
            .Write("web/src/skills/lib/format.test.ts");
    ...
    [Fact]
    public void Code_in_the_other_language_is_not_the_code_a_test_mirrors()
    {
        using var tree = new RulesTree()
            .Write("src/App/App.csproj", ProjectFile)
