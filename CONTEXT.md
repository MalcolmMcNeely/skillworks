...
Skillworks builds, ships and measures Claude Code agent skills. It publishes one Claude Code
plugin through a marketplace, and it runs a local app for watching how those skills behave.
...
**Plugin**:
The one installable unit Skillworks publishes. It is the product. It holds skills, hooks, output
styles and MCP servers.
