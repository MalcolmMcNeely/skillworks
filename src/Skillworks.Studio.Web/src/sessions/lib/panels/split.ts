...
const parts: readonly Part[] = [
  ...
  { part: 'hooks', word: 'Hooks', note: 'Hook scripts the main thread ran, before or after a tool call.' },
  {
    part: 'tools',
    word: 'Tools running',
    note: 'Main-thread tool calls, from the moment they were allowed to the moment they came back.',
  },
  { part: 'model', word: 'Model thinking', note: 'Main-thread turns, from the request to the last word.' },
  {
    part: 'subagents',
    word: 'Only subagents',
    note: 'The main thread had nothing running and waited on a subagent.',
  },
